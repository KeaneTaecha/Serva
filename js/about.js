...
(function () {
  const translations = {
    en: {
      ...
      'about.meta.uptime':    'datacenter uptime sla',
      'about.meta.backup':    'backup cycle',
      ...
      'about.val2.desc':    '99.97% datacenter uptime SLA. 24/7 monitoring. We remain accountable long after the first deployment.',
    ...
    th: {
      ...
      'about.val2.desc':    'datacenter uptime SLA 99.97% monitoring 24/7 เรารับผิดชอบต่อเนื่องนานหลังการ deploy ครั้งแรก',
