...
(function () {
  const translations = {
    en: {
      ...
      'nav.process':        'process',
      'nav.contact':        'contact',
      'hero.heading':       'Yours to rent,<br>from <span class="accent">฿147</span>/mo.',
      ...
      'footer.copy':        '&copy; 2026 Serva Services. All rights reserved.',
      ...
      'why.item2.title':    '99.97% Datacenter Uptime',
      'why.item2.desc':     'Our datacenter partner guarantees 99.97% facility uptime, backed by redundant infrastructure and continuous 24/7 monitoring.',
      ...
      'off.dedicated.desc': 'Full hardware access, 99.97% datacenter uptime SLA. NVIDIA GPU available for AI and compute workloads.',
    ...
    th: {
      ...
      'nav.contact':        'ติดต่อ',
      'hero.heading':       'เช่าได้ทันที<br>เริ่มต้นเพียง <span class="accent">฿147</span>/เดือน',
      ...
      'footer.copy':        '&copy; 2026 Serva Services. สงวนลิขสิทธิ์ทุกประการ.',
      ...
      'why.item2.title':    'Datacenter Uptime 99.97%',
      'why.item2.desc':     'ดาต้าเซ็นเตอร์พาร์ตเนอร์ของเรารับประกัน uptime 99.97% รองรับด้วย infrastructure แบบ redundant และการตรวจสอบ 24/7 ต่อเนื่อง',
      ...
      'off.dedicated.name': 'GPU Dedicated Server',
      'off.dedicated.desc': 'เข้าถึง hardware เต็มที่ ไม่มีการรบกวนจากผู้เช่าอื่น SLA datacenter uptime 99.97% NVIDIA GPU พร้อมสำหรับ AI และ compute workload',
