...
(function () {
  const translations = {
    en: {
      ...
      'offerings.sub':      'Two product lines. Three managed services. One team behind all of it — ready to deploy on your terms.',
      'off.vps.name':       'Virtual Private Servers',
      'off.vps.desc':       'Full root access, SSD storage, and flexible billing — hourly or monthly. Spin up in minutes, scale without contracts.',
      'off.vps.link':       'view plans →',
      'off.dedicated.name': 'GPU Dedicated Server',
      'off.dedicated.desc': 'Full hardware access, zero noisy neighbors, 99.99% uptime SLA. NVIDIA GPU available for AI and compute workloads.',
      ...
      'svc.hero.heading':   'Built for<br>your <em>stack.</em>',
      ...
      'svc.offer.title':    'Three services.<br>One team.',
    ...
    th: {
      ...
      'svc.hero.heading':   'สร้างขึ้นเพื่อ<br><em>stack</em> ของคุณ.',
      ...
      'svc.offer.title':    'สามบริการ.<br>ทีมเดียว.',
